    ...
    public partial class InitialcommitApplication : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "ATK", "Alat tulis kantor" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CategoryName", "Description" },
                values: new object[] { 2, "Buku Tulis", "Buku Tulis" });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Address", "City", "ContactName", "ContactTitle", "Country", "CustomerName", "Fax", "Phone", "PostalCode", "Region" },
                values: new object[] { 1, "Jalan in aja dulu", "Malang", "hafiz", "hafiz", "Indonesia", "Hafizhan Al Wafi", "0000", "0000", "65125", "East Java" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Price", "ProductName" },
                values: new object[] { 1, 1, 3000m, "Pensil 2B" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Price", "ProductName" },
                values: new object[] { 2, 2, 5000m, "Buku Tulis Sinar" });
